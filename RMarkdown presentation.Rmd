...
institute: "Email: `<yebelay.ma@gmail.com>`"
          
date: '`r Sys.Date()`'
output:
  xaringan::moon_reader:
    css: [ xaringan-themer.css, metropolis]
    nature:
      ratio: "14:9"
      highlightLines: true
      highlightSpans: true
...
xaringanExtra::use_logo(image_url = "logo.png",   width = "90px",height = "85px")
```
